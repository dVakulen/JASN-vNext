...
(function (todos) {
    ...
    var TodoCtrl = (function () {
        ...
        function TodoCtrl($scope, $location, todoStorage, filterFilter) {
            ...
            this.todos.push(new todos.TodoItem("sass", false));
            $scope.newTodo = '';
            ...
            $scope.$watch('location.path()', function (path) { return _this.onPath(path.toString()); });
            if ($location.path() === '')
                $location.path('/');
            $scope.location = $location;
        }
        TodoCtrl.Factory = function () {
            alert("asd");
            var directive = function ($scope, $location, todoStorage, filterFilter) {
                return new TodoCtrl($scope, $location, todoStorage, filterFilter);
            };
